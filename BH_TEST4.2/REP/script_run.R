...
mystudy<-initStudy(fn_studyName = 'TEST_ROUND1',
                   fn_rootFolder = "C:/Users/luigi/Documents/BH_TEST/BH_TEST4.2/REP_1",
                   fn_rawDataFolder = "C:/Users/luigi/Documents/BH_TEST/BH_TEST4.2/REP_1/XYZfiles"  )
...
addClassificationDirectives(x = mystudy,
                            ...
                            methodParameters = list(responseVariable = 'SLI',
                                                    ...
                                                    predictiveFeatures = availableTF,
                                                    prefix = 'sko_',
                                                    labels = tf_labelList(mystudy)[1:5],
                                                    importance = F,
                                                    mtry = 50,
                                                    ntree = 5000,
                                                    do.trace=500))
...
mystudy$currentAnalysis$segmentationDirectives@methodParameters$nOfCutBrakes = 5

archive(mystudy)

segment(mystudy,
        labelLayer = names(mystudy$currentAnalysis$classification[[1]])[c(8:12)])
...
sf::write_sf(topLayers,
             "C:/Users/luigi/Documents/BH_TEST/BH_TEST4.2/REP_1/TEST_ROUND1/analysis/RUNIMC1/topLayers.sqlite")
...
# mystudy<-retrieve("C:/Users/luigi/Documents/BH_TEST/BH_TEST4.2/REP_1/TEST_ROUND1/study.xml" )

newAnalysis(x = mystudy,
            analysisName = 'BODEN1')

importTiffMask(x = mystudy,
               fileFolder = "C:/Users/luigi/Documents/BH_TEST/BH_TEST4.2/REP_1/cellprofiler/cpTotImg_noshrink"  ,
               layerName = 'bo_',
)
