...
cytop_imm<-bh_defineShape(majorAxis = c(4,0.1),
                          minorAxis = c(4,0.1),
                          roundness = c(1,0),
                          nArms = 6,
                          fixedArms = T,
...
cytop_tum<-bh_defineShape(majorAxis = c(10,0.5),
                          minorAxis = c(10,0.5),
                          roundness = c(0.4,0),
                          nArms = 5,
                          fixedArms = T,
...
nuc_imm<-bh_defineShape(majorAxis = c(4,0.05),
                        minorAxis = c(2,0.05),
                        roundness = c(1,0),
                        nArms = 6,
                        fixedArms = T,
...
nuc_tum<-bh_defineShape(majorAxis = c(6,0.01),
                        minorAxis = c(4,0.01),
                        roundness = c(1,0),
                        nArms = 6,
                        fixedArms = T,
...
dirList<-list.dirs(
  "C:/Users/luigi/Documents/BH_TEST/BH_TEST5.1",recursive = F
)
