...
mystudy<-initStudy(fn_studyName = 'RUN_001',
                   fn_rootFolder = "C:/Users/luigi/Documents/BH_TEST/HEADANDNECK"  ,
                   fn_rawDataFolder = "C:/Users/luigi/Documents/BH_TEST/HEADANDNECK/RAWDATA"  )
...
addClassificationDirectives(x = mystudy,
                            ...
                            methodParameters = list(responseVariable = 'SLI',
                                                    ...
                                                    predictiveFeatures = availableTF,
                                                    prefix = 'sko_',
                                                    labels = tf_labelList(mystudy)[c(1:6)],
                                                    importance = F,
                                                    mtry = 250,
                                                    ntree = 1000,
                                                    do.trace=200))
...
segment(mystudy,
        labelLayer = names(mystudy$currentAnalysis$classification[[1]])[c(11:15,17)])
...
importTiffMask(x = mystudy,
               fileFolder = "C:/Users/luigi/Documents/BH_TEST/HEADANDNECK/CP/MASK"  ,
               layerName = 'bo',
               flipImage = 'y'
)
