...
saveRDS(fsom,
        file = "C:/Users/luigi/Documents/BH_TEST/MYELOMA/RUN_002/COMPARISONS_reordered/5x5_som"  )
...
pdf(file="C:/Users/luigi/Documents/BH_TEST/MYELOMA/RUN_002/COMPARISONS_reordered/5x5_heatmap.pdf",
    width = 5,
    height = 5
)
...
for (i in 1:3){
  postscript(file = paste0("C:/Users/luigi/Documents/BH_TEST/MYELOMA/RUN_002/COMPARISONS_reordered/5x5_BO_map_",i,".eps"),
             height = 10,
             width = 50,
             horizontal = F,
             bg = 'white',
  ...
  plot(geo_list_BO_annot[geo_list_BO_annot$uid==uids[i],]['SOM'],
       ...
       key.length = 1)
  dev.off()
  postscript(file = paste0("C:/Users/luigi/Documents/BH_TEST/MYELOMA/RUN_002/COMPARISONS_reordered/5x5_RU_map_",i,".eps"),
             height = 10,
             width = 50,
             horizontal = F,
             bg = 'white',
...
pdf(file="C:/Users/luigi/Documents/BH_TEST/MYELOMA/RUN_002/COMPARISONS_reordered/5X5_heatmap_prePost.pdf",
    width = 10,
    height = 3.5
)


prePost<-pheatmap::pheatmap(prePostTable,
                   scale = 'none',
                   angle_col = 0)
...
for (ii in 1:3){
  postscript(file = paste0("C:/Users/luigi/Documents/BH_TEST/MYELOMA/RUN_002/COMPARISONS_reordered/5x5_BO_map_split_",ii,".eps"),
             height = 50,
             width = 50,
             horizontal = F,
             bg = 'white',
  ...
  for (i in formatC(prePost$tree_col$order,width = 2,flag='0')){
  ...
  dev.off()
  postscript(file = paste0("C:/Users/luigi/Documents/BH_TEST/MYELOMA/RUN_002/COMPARISONS_reordered/5x5_RU_map_split_",ii,".eps"),
             height = 50,
             width = 50,
             horizontal = F,
             bg = 'white',
