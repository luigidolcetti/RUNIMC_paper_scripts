...
saveRDS(fsom,
        file = "C:/Users/luigi/Documents/BH_TEST/MYELOMA/RUN_001//som"  )
...
pdf(file="C:/Users/luigi/Documents/BH_TEST/MYELOMA/RUN_001/heatmap.pdf",
    width = 5,
    height = 5
)
...
for (i in 1:3){
  postscript(file = paste0("C:/Users/luigi/Documents/BH_TEST/MYELOMA/RUN_001/BO_map_",i,".eps"),
             height = 10,
             width = 50,
             horizontal = F,
             bg = 'white',
  ...
  plot(geo_list_BO_annot[geo_list_BO_annot$uid==uids[i],]['SOM'],
       ...
       key.length = 1)
  dev.off()
  postscript(file = paste0("C:/Users/luigi/Documents/BH_TEST/MYELOMA/RUN_001/RU_map_",i,".eps"),
             height = 10,
             width = 50,
             horizontal = F,
             bg = 'white',
...
pdf(file="C:/Users/luigi/Documents/BH_TEST/MYELOMA/RUN_001/heatmap_prePost.pdf",
    width = 10,
    height = 3.5
)
...
for (ii in 1:3){
  postscript(file = paste0("C:/Users/luigi/Documents/BH_TEST/MYELOMA/RUN_001/BO_map_split_",ii,".eps"),
             height = 50,
             width = 50,
             horizontal = F,
             bg = 'white',
  ...
  dev.off()
  postscript(file = paste0("C:/Users/luigi/Documents/BH_TEST/MYELOMA/RUN_001/RU_map_split_",ii,".eps"),
             height = 50,
             width = 50,
             horizontal = F,
             bg = 'white',
